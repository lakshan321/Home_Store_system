    ...
    <div className="p-5 max-w-5xl mx-auto">
      ...
      <div className="overflow-x-auto">
        <Table hoverable striped>
          <Table.Head>
            <Table.HeadCell className="text-lg font-bold">Item Name</Table.HeadCell>
            <Table.HeadCell className="text-lg font-bold">Supplier</Table.HeadCell>
            <Table.HeadCell className="text-lg font-bold">Price</Table.HeadCell>
            <Table.HeadCell className="text-lg font-bold">Quantity</Table.HeadCell>
            <Table.HeadCell className="text-lg font-bold">Exp Date</Table.HeadCell>
            <Table.HeadCell className="text-lg font-bold">Action</Table.HeadCell>
          </Table.Head>
          <Table.Body>
